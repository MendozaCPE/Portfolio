...
export const projects = [
    ...
    {
        title: 'Real Estate Management System - AMB Real Estate',
        description: 'Real-time weather tracking application with interactive maps, detailed forecasts, and location services.',
        tags: ['PHP', 'HTML/CSS', 'JS', 'MySQL', 'Bootstrap', 'CodeIgniter'],
        image: '/AMB.png',
        github: 'https://github.com/yourusername/weather-dashboard',
        demo: 'https://github.com/Catliaj/AMB-WEB.git',
    },
    {
